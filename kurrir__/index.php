...
if ($_SESSION['role'] === 'admin') {
  ...
  $query = "SELECT * FROM items WHERE id = $_SESSION[user_id]";
}
    ...
    <div>
      <ul class="d-flex align-items-center pt-2 pe-1">
        <?php if ($_SESSION['role'] === 'admin') : ?>
          <li>
            <a type="button" class="btn btn-primary me-2" href="items_list.php">
              Daftar barang
            </a>
          </li>
        <?php endif ?>
        <li>
          <button type="button" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#addItem">
            Tambah barang
          </button>
        </li>
        <li>
          <div class="dropdown notif">
            <button class="btn btn-warning me-2 dropdown-toggle" type="button" data-bs-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              if (count($items) > 0) :
                ...
                <li><a class="dropdown-item d-flex justify-content-center">
                    <p>Tidak ada barang yang sedang dikirim</p>
                  </a></li>
              <?php endif ?>
            </ul>
          </div>
